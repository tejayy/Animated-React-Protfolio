...
const SectionItem = ({title, subtitle, year, details, icon}) => {
  return (
    <motion.article
      ...
      viewport={{once: false}}
      className="relative flex flex-col justify-end px-2 gap-3 rounded-lg cursor-pointer before:absolute before:inset-[10px] before:rounded-[10px] before:bg-gradient-to-br before:from-primary before:to-secondary before:z-[-10] after:absolute after:inset-0 after:bg-gradient-to-br after:from-primary after:to-secondary after:scale-[0.95] after:blur-[20px] hover:after:blur-[30px] mt-10">
